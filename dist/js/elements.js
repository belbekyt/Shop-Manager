...
const sendFormCostumer = document.querySelector("#submitCostumerForm");
...
const sendFormOrder = document.querySelector("#submitOrderForm");
const costumerIdInput = document.querySelector("#costumerIdInput");
